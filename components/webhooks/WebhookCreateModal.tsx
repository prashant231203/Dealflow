...
const AVAILABLE_EVENTS = [
    ...
    { id: 'deal.offer.accepted', label: 'Offer Accepted', desc: 'When pricing terms are finalized' },
    { id: 'deal.closed', label: 'Deal Closed', desc: 'When the flow reaches terminal state' },
    { id: 'deal.escalated', label: 'Escalations', desc: 'When an agent needs human review' },
    { id: 'deal.compliance.flagged', label: 'Compliance Flags', desc: 'When bounds or rules are broken' },
]
...
export function WebhookCreateModal({ isOpen, onClose, onSuccess }: WebhookCreateModalProps) {
    ...
    const handleCreate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (insertError) {
                throw new Error(insertError.message || 'Failed to create webhook')
            }
